            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  ...
                  />
                  <p className="text-gray-700 h8-8 w-auto pl-4 text-xs sm:text-sm md:text-lg">Online biblioteka</p>
                </div>
                <div className="hidden sm:flex content-center mx-auto justify-center justify-content-center justify-items-center">
